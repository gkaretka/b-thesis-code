...
# module references:
# aresetn_gen, bb_generator, clocker2, dac_reg, status_reg_conc
...
proc create_root_design { parentCell } {
  ...
  set btn_i [ create_bd_port -dir I -from 0 -to 0 btn_i ]
  ...
  # Create instance: bb_generator_0, and set properties
  set block_name bb_generator
  set block_cell_name bb_generator_0
  if { [catch {set bb_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bb_generator_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../SupportFiles/passed.coe} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.B_Value {00001000001100000000000000000000} \
   CONFIG.B_Width {32} \
   CONFIG.Latency {1} \
   CONFIG.Out_Width {32} \
 ] $c_addsub_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.PINC1 {1100110011001100110011001100} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.Noise_Shaping {Auto} \
   CONFIG.Optimization_Goal {Speed} \
   CONFIG.Output_Frequency1 {42.3} \
   CONFIG.Output_Selection {Sine} \
   CONFIG.Output_Width {16} \
   CONFIG.PINC1 {101011010100001011000011110010} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.M_DATA_Has_TUSER {Not_Required} \
   CONFIG.Noise_Shaping {Auto} \
   CONFIG.Output_Frequency1 {1.075} \
   CONFIG.Output_Selection {Sine} \
   CONFIG.Output_Width {16} \
   CONFIG.PINC1 {1000110011100111000000111} \
  ...
  connect_bd_net -net bb_generator_0_addr [get_bd_pins bb_generator_0/addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net bb_generator_0_oe_out [get_bd_pins bb_generator_0/oe_out] [get_bd_pins dac_reg_0/oe_dac]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins mult_gen_1/A]
  connect_bd_net -net btn_i_1 [get_bd_ports btn_i] [get_bd_pins bb_generator_0/btn_i]
  connect_bd_net -net c_addsub_0_S [get_bd_pins c_addsub_0/S] [get_bd_pins dds_compiler_3/s_axis_config_tdata]
  ...
  connect_bd_net -net clocker2_0_clk8ksps [get_bd_pins bb_generator_0/ce] [get_bd_pins clocker2_0/clk8ksps]
  ...
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dac_reg_0/dac_ch1] [get_bd_pins dds_compiler_0/m_axis_data_tdata]
  ...
  connect_bd_net -net dds_compiler_3_m_axis_data_tdata [get_bd_pins dds_compiler_3/m_axis_data_tdata] [get_bd_pins mult_gen_0/B]
  ...
  connect_bd_net -net pll_0_clk_out1 [get_bd_pins adc_0/aclk] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins bb_generator_0/clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins c_addsub_0/CLK] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins cfg_0/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clocker2_0/clk] [get_bd_pins conv_0/aclk] [get_bd_pins dac_reg_0/clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins dds_compiler_3/aclk] [get_bd_pins mult_gen_0/CLK] [get_bd_pins pll_0/clk_out1] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins ps_0/S_AXI_HP0_ACLK] [get_bd_pins ps_0_axi_periph/ACLK] [get_bd_pins ps_0_axi_periph/M00_ACLK] [get_bd_pins ps_0_axi_periph/M01_ACLK] [get_bd_pins ps_0_axi_periph/S00_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins sts_0/aclk] [get_bd_pins subset_0/aclk] [get_bd_pins writer_0/aclk]
  connect_bd_net -net pll_0_locked [get_bd_pins pll_0/locked] [get_bd_pins rst_0/dcm_locked]
  connect_bd_net -net rst_0_interconnect_aresetn [get_bd_pins clocker2_0/resetn] [get_bd_pins dac_reg_0/resetn] [get_bd_pins ps_0_axi_periph/ARESETN] [get_bd_pins rst_0/interconnect_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins bb_generator_0/resetn] [get_bd_pins clocker2_0/clock_enable] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins c_addsub_0/CE] [get_bd_pins dds_compiler_3/s_axis_config_tvalid] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins dac_reg_0/dac_ch0] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports led_o] [get_bd_pins xlslice_1/Dout]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces ps_0/Data] [get_bd_addr_segs cfg_0/s_axi/reg0] SEG_cfg_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces ps_0/Data] [get_bd_addr_segs sts_0/s_axi/reg0] SEG_sts_0_reg0
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces writer_0/M_AXI] [get_bd_addr_segs ps_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps_0_HP0_DDR_LOWOCM
